...
$(document).ready(function(){
	...
	if(responseCaptcha.length == 0) 
        {
            alertify.alert('<span class="text-danger"><i class="fas fa-exclamation-circle"></i> Aviso!</span>', 'Debe completar el campo "No soy un robot" para continuar');
            generateAlertRequired(true);
        }
